...
In file included from /home/ubuntu/workspace/sdk/sysroots/cortexa72-cortexa53-xilinx-linux/usr/include/bits/libc-header-start.h:33,
                 from /home/ubuntu/workspace/sdk/sysroots/cortexa72-cortexa53-xilinx-linux/usr/include/stdio.h:27,
                 from xilinx_vdma.c:1:
/home/ubuntu/workspace/sdk/sysroots/cortexa72-cortexa53-xilinx-linux/usr/include/features.h:397:4: warning: #warning _FORTIFY_SOURCE requires compiling with optimization (-O) [-Wcpp]
  397 | #  warning _FORTIFY_SOURCE requires compiling with optimization (-O)
      |    ^~~~~~~
xilinx_vdma.c: In function ‘vdma_s2mm_ptr’:
xilinx_vdma.c:77:40: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int’ [-Wformat=]
   77 |     printf ("PARK_PTR_REG value is 0x%lx \n", s2mm_status);
      |                                      ~~^      ~~~~~~~~~~~
      |                                        |      |
      |                                        |      unsigned int
      |                                        long unsigned int
      |                                      %x
xilinx_vdma.c: In function ‘vdma_status_read’:
xilinx_vdma.c:86:34: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int’ [-Wformat=]
   86 |     printf("S2MM status reg: 0x%lx\n", status);
      |                                ~~^     ~~~~~~
      |                                  |     |
      |                                  |     unsigned int
      |                                  long unsigned int
      |                                %x
xilinx_vdma.c: In function ‘main’:
xilinx_vdma.c:126:58: warning: implicit declaration of function ‘strerror’; did you mean ‘perror’? [-Wimplicit-function-declaration]
  126 |         printf("open /dev/mem  fd failed, error: %s \n", strerror(errno));
      |                                                          ^~~~~~~~
      |                                                          perror
xilinx_vdma.c:126:51: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  126 |         printf("open /dev/mem  fd failed, error: %s \n", strerror(errno));
      |                                                  ~^      ~~~~~~~~~~~~~~~
      |                                                   |      |
      |                                                   char * int
      |                                                  %d
xilinx_vdma.c:132:52: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  132 |         printf("vdma_reg_baseaddr is NULL, error: %s \n", strerror(errno));
      |                                                   ~^      ~~~~~~~~~~~~~~~
      |                                                    |      |
      |                                                    char * int
      |                                                   %d
xilinx_vdma.c:136:70: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  136 | rintf ("vdma_reg_baseaddr map successfull, the address is %lx \n", vdma_reg_baseaddr);
      |                                                           ~~^      ~~~~~~~~~~~~~~~~~
      |                                                             |      |
      |                                                             |      unsigned int *
      |                                                             long unsigned int
      |                                                           %ls
xilinx_vdma.c:141:48: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  141 |         printf("pl_ps_com_reg is NULL, error: %s \n", strerror(errno));
      |                                               ~^      ~~~~~~~~~~~~~~~
      |                                                |      |
      |                                                char * int
      |                                               %d
xilinx_vdma.c:145:66: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  145 |    printf ("pl_ps_com_reg map successfull, the address is %lx \n", pl_ps_com_reg);
      |                                                           ~~^      ~~~~~~~~~~~~~
      |                                                             |      |
      |                                                             |      unsigned int *
      |                                                             long unsigned int
      |                                                           %ls
xilinx_vdma.c:150:50: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  150 |         printf("dma_dist_addr_1 is NULL, error: %s \n", strerror(errno));
      |                                                 ~^      ~~~~~~~~~~~~~~~
      |                                                  |      |
      |                                                  char * int
      |                                                 %d
xilinx_vdma.c:154:68: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  154 |  printf ("dma_dist_addr_1 map successfull, the address is %lx \n", dma_dist_addr_1);
      |                                                           ~~^      ~~~~~~~~~~~~~~~
      |                                                             |      |
      |                                                             |      unsigned int *
      |                                                             long unsigned int
      |                                                           %ls
xilinx_vdma.c:159:50: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  159 |         printf("dma_dist_addr_2 is NULL, error: %s \n", strerror(errno));
      |                                                 ~^      ~~~~~~~~~~~~~~~
      |                                                  |      |
      |                                                  char * int
      |                                                 %d
xilinx_vdma.c:163:68: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  163 |  printf ("dma_dist_addr_2 map successfull, the address is %lx \n", dma_dist_addr_2);
      |                                                           ~~^      ~~~~~~~~~~~~~~~
      |                                                             |      |
      |                                                             |      unsigned int *
      |                                                             long unsigned int
      |                                                           %ls
xilinx_vdma.c:168:50: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘int’ [-Wformat=]
  168 |         printf("dma_dist_addr_3 is NULL, error: %s \n", strerror(errno));
      |                                                 ~^      ~~~~~~~~~~~~~~~
      |                                                  |      |
      |                                                  char * int
      |                                                 %d
xilinx_vdma.c:172:68: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  172 |  printf ("dma_dist_addr_3 map successfull, the address is %lx \n", dma_dist_addr_3);
      |                                                           ~~^      ~~~~~~~~~~~~~~~
      |                                                             |      |
      |                                                             |      unsigned int *
      |                                                             long unsigned int
      |                                                           %ls
xilinx_vdma.c:193:5: warning: implicit declaration of function ‘dma_status_read’; did you mean ‘vdma_status_read’? [-Wimplicit-function-declaration]
  193 |     dma_status_read(vdma_reg_baseaddr);
      |     ^~~~~~~~~~~~~~~
      |     vdma_status_read
xilinx_vdma.c:197:45: warning: format ‘%lx’ expects argument of type ‘long unsigned int’, but argument 2 has type ‘unsigned int *’ [-Wformat=]
  197 |     printf("data at destination address 0x%lx: ", dma_dist_addr_1);
      |                                           ~~^     ~~~~~~~~~~~~~~~
      |                                             |     |
      |                                             |     unsigned int *
      |                                             long unsigned int
      |                                           %ls
/home/ubuntu/workspace/sdk/sysroots/x86_64-petalinux-linux/usr/libexec/aarch64-xilinx-linux/gcc/aarch64-xilinx-linux/10.2.0/real-ld: /tmp/ccpMjTgE.o: in function `main':
xilinx_vdma.c:(.text+0x538): undefined reference to `dma_status_read'
